...
ros::Publisher  to_qgc_mav_raw_data_publisher;        //! ROS publisher to write to qgc
ros::Subscriber from_qgc_mav_raw_data_subscriber;     //! ROS subscriber to read from mavlink interface

	ros::Publisher to_mav_heartbeat_pub;
	ros::Publisher to_mav_sys_status_pub;
	ros::Publisher to_mav_system_time_pub;
	ros::Publisher to_mav_ping_pub;
	ros::Publisher to_mav_change_operator_control_pub;
	ros::Publisher to_mav_change_operator_control_ack_pub;
	ros::Publisher to_mav_auth_key_pub;
	ros::Publisher to_mav_set_mode_pub;
	ros::Publisher to_mav_param_request_read_pub;
	ros::Publisher to_mav_param_request_list_pub;
	ros::Publisher to_mav_param_value_pub;
	ros::Publisher to_mav_param_set_pub;
	ros::Publisher to_mav_gps_raw_int_pub;
	ros::Publisher to_mav_gps_status_pub;
	ros::Publisher to_mav_scaled_imu_pub;
	ros::Publisher to_mav_raw_imu_pub;
	ros::Publisher to_mav_raw_pressure_pub;
	ros::Publisher to_mav_scaled_pressure_pub;
	ros::Publisher to_mav_attitude_pub;
	ros::Publisher to_mav_attitude_quaternion_pub;
	ros::Publisher to_mav_local_position_ned_pub;
	ros::Publisher to_mav_global_position_int_pub;
	ros::Publisher to_mav_rc_channels_scaled_pub;
	ros::Publisher to_mav_rc_channels_raw_pub;
	ros::Publisher to_mav_servo_output_raw_pub;
	ros::Publisher to_mav_mission_request_partial_list_pub;
	ros::Publisher to_mav_mission_write_partial_list_pub;
	ros::Publisher to_mav_mission_item_pub;
	ros::Publisher to_mav_mission_request_pub;
	ros::Publisher to_mav_mission_set_current_pub;
	ros::Publisher to_mav_mission_current_pub;
	ros::Publisher to_mav_mission_request_list_pub;
	ros::Publisher to_mav_mission_count_pub;
	ros::Publisher to_mav_mission_clear_all_pub;
	ros::Publisher to_mav_mission_item_reached_pub;
	ros::Publisher to_mav_mission_ack_pub;
	ros::Publisher to_mav_set_gps_global_origin_pub;
	ros::Publisher to_mav_gps_global_origin_pub;
	ros::Publisher to_mav_set_local_position_setpoint_pub;
	ros::Publisher to_mav_local_position_setpoint_pub;
	ros::Publisher to_mav_global_position_setpoint_int_pub;
	ros::Publisher to_mav_set_global_position_setpoint_int_pub;
	ros::Publisher to_mav_safety_set_allowed_area_pub;
	ros::Publisher to_mav_safety_allowed_area_pub;
	ros::Publisher to_mav_set_roll_pitch_yaw_thrust_pub;
	ros::Publisher to_mav_set_roll_pitch_yaw_speed_thrust_pub;
	ros::Publisher to_mav_roll_pitch_yaw_thrust_setpoint_pub;
	ros::Publisher to_mav_roll_pitch_yaw_speed_thrust_setpoint_pub;
	ros::Publisher to_mav_set_quad_motors_setpoint_pub;
	ros::Publisher to_mav_set_quad_swarm_roll_pitch_yaw_thrust_pub;
	ros::Publisher to_mav_nav_controller_output_pub;
	ros::Publisher to_mav_set_quad_swarm_led_roll_pitch_yaw_thrust_pub;
	ros::Publisher to_mav_state_correction_pub;
	ros::Publisher to_mav_request_data_stream_pub;
	ros::Publisher to_mav_data_stream_pub;
	ros::Publisher to_mav_manual_control_pub;
	ros::Publisher to_mav_rc_channels_override_pub;
	ros::Publisher to_mav_vfr_hud_pub;
	ros::Publisher to_mav_command_long_pub;
	ros::Publisher to_mav_command_ack_pub;
	ros::Publisher to_mav_roll_pitch_yaw_rates_thrust_setpoint_pub;
	ros::Publisher to_mav_manual_setpoint_pub;
	ros::Publisher to_mav_local_position_ned_system_global_offset_pub;
	ros::Publisher to_mav_hil_state_pub;
	ros::Publisher to_mav_hil_controls_pub;
	ros::Publisher to_mav_hil_rc_inputs_raw_pub;
	ros::Publisher to_mav_optical_flow_pub;
	ros::Publisher to_mav_global_vision_position_estimate_pub;
	ros::Publisher to_mav_vision_position_estimate_pub;
	ros::Publisher to_mav_vision_speed_estimate_pub;
	ros::Publisher to_mav_vicon_position_estimate_pub;
	ros::Publisher to_mav_highres_imu_pub;
	ros::Publisher to_mav_file_transfer_start_pub;
	ros::Publisher to_mav_file_transfer_dir_list_pub;
	ros::Publisher to_mav_file_transfer_res_pub;
	ros::Publisher to_mav_battery_status_pub;
	ros::Publisher to_mav_setpoint_8dof_pub;
	ros::Publisher to_mav_setpoint_6dof_pub;
	ros::Publisher to_mav_memory_vect_pub;
	ros::Publisher to_mav_debug_vect_pub;
	ros::Publisher to_mav_named_value_float_pub;
	ros::Publisher to_mav_named_value_int_pub;
	ros::Publisher to_mav_statustext_pub;
	ros::Publisher to_mav_debug_pub;
	ros::Publisher to_mav_sensor_offsets_pub;
	ros::Publisher to_mav_set_mag_offsets_pub;
	ros::Publisher to_mav_meminfo_pub;
	ros::Publisher to_mav_ap_adc_pub;
	ros::Publisher to_mav_digicam_configure_pub;
	ros::Publisher to_mav_digicam_control_pub;
	ros::Publisher to_mav_mount_configure_pub;
	ros::Publisher to_mav_mount_control_pub;
	ros::Publisher to_mav_mount_status_pub;
	ros::Publisher to_mav_fence_point_pub;
	ros::Publisher to_mav_fence_fetch_point_pub;
	ros::Publisher to_mav_fence_status_pub;
	ros::Publisher to_mav_ahrs_pub;
	ros::Publisher to_mav_simstate_pub;
	ros::Publisher to_mav_hwstatus_pub;
	ros::Publisher to_mav_radio_pub;
	ros::Publisher to_mav_limits_status_pub;
	ros::Publisher to_mav_wind_pub;
	ros::Publisher to_mav_data16_pub;
	ros::Publisher to_mav_data32_pub;
	ros::Publisher to_mav_data64_pub;
	ros::Publisher to_mav_data96_pub;


/**
 * 
 **/
int write_to_qgc (uint8_t * b, int sz){
    ...
    int rc = m.data.size();
    to_qgc_mav_raw_data_publisher.publish(m);
    ROS_INFO("Writen to qgc %d bytes",rc);
    return rc;
}        
 ...
 *
 */            
void from_mav_heartbeat_callback(const mavlink_common::HEARTBEAT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_HEARTBEAT request");
    ...
    write_to_qgc(data,len);
    
}
/**
 *
 */            
void from_mav_sys_status_callback(const mavlink_common::SYS_STATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SYS_STATUS request");
 ...
 *
 */            
void from_mav_system_time_callback(const mavlink_common::SYSTEM_TIME::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SYSTEM_TIME request");
 ...
 *
 */            
void from_mav_ping_callback(const mavlink_common::PING::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_PING request");
 ...
 *
 */            
void from_mav_change_operator_control_callback(const mavlink_common::CHANGE_OPERATOR_CONTROL::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_CHANGE_OPERATOR_CONTROL request");
 ...
 *
 */            
void from_mav_change_operator_control_ack_callback(const mavlink_common::CHANGE_OPERATOR_CONTROL_ACK::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_CHANGE_OPERATOR_CONTROL_ACK request");
 ...
 *
 */            
void from_mav_auth_key_callback(const mavlink_common::AUTH_KEY::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_AUTH_KEY request");
 ...
 *
 */            
void from_mav_set_mode_callback(const mavlink_common::SET_MODE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_MODE request");
 ...
 *
 */            
void from_mav_param_request_read_callback(const mavlink_common::PARAM_REQUEST_READ::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_PARAM_REQUEST_READ request");
 ...
 *
 */            
void from_mav_param_request_list_callback(const mavlink_common::PARAM_REQUEST_LIST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_PARAM_REQUEST_LIST request");
 ...
 *
 */            
void from_mav_param_value_callback(const mavlink_common::PARAM_VALUE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_PARAM_VALUE request");
 ...
 *
 */            
void from_mav_param_set_callback(const mavlink_common::PARAM_SET::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_PARAM_SET request");
 ...
 *
 */            
void from_mav_gps_raw_int_callback(const mavlink_common::GPS_RAW_INT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_GPS_RAW_INT request");
 ...
 *
 */            
void from_mav_gps_status_callback(const mavlink_common::GPS_STATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_GPS_STATUS request");
 ...
 *
 */            
void from_mav_scaled_imu_callback(const mavlink_common::SCALED_IMU::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SCALED_IMU request");
 ...
 *
 */            
void from_mav_raw_imu_callback(const mavlink_common::RAW_IMU::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_RAW_IMU request");
 ...
 *
 */            
void from_mav_raw_pressure_callback(const mavlink_common::RAW_PRESSURE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_RAW_PRESSURE request");
 ...
 *
 */            
void from_mav_scaled_pressure_callback(const mavlink_common::SCALED_PRESSURE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SCALED_PRESSURE request");
 ...
 *
 */            
void from_mav_attitude_callback(const mavlink_common::ATTITUDE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_ATTITUDE request");
 ...
 *
 */            
void from_mav_attitude_quaternion_callback(const mavlink_common::ATTITUDE_QUATERNION::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_ATTITUDE_QUATERNION request");
 ...
 *
 */            
void from_mav_local_position_ned_callback(const mavlink_common::LOCAL_POSITION_NED::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_LOCAL_POSITION_NED request");
 ...
 *
 */            
void from_mav_global_position_int_callback(const mavlink_common::GLOBAL_POSITION_INT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_GLOBAL_POSITION_INT request");
 ...
 *
 */            
void from_mav_rc_channels_scaled_callback(const mavlink_common::RC_CHANNELS_SCALED::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_RC_CHANNELS_SCALED request");
 ...
 *
 */            
void from_mav_rc_channels_raw_callback(const mavlink_common::RC_CHANNELS_RAW::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_RC_CHANNELS_RAW request");
 ...
 *
 */            
void from_mav_servo_output_raw_callback(const mavlink_common::SERVO_OUTPUT_RAW::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SERVO_OUTPUT_RAW request");
 ...
 *
 */            
void from_mav_mission_request_partial_list_callback(const mavlink_common::MISSION_REQUEST_PARTIAL_LIST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_REQUEST_PARTIAL_LIST request");
 ...
 *
 */            
void from_mav_mission_write_partial_list_callback(const mavlink_common::MISSION_WRITE_PARTIAL_LIST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_WRITE_PARTIAL_LIST request");
 ...
 *
 */            
void from_mav_mission_item_callback(const mavlink_common::MISSION_ITEM::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_ITEM request");
 ...
 *
 */            
void from_mav_mission_request_callback(const mavlink_common::MISSION_REQUEST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_REQUEST request");
 ...
 *
 */            
void from_mav_mission_set_current_callback(const mavlink_common::MISSION_SET_CURRENT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_SET_CURRENT request");
 ...
 *
 */            
void from_mav_mission_current_callback(const mavlink_common::MISSION_CURRENT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_CURRENT request");
 ...
 *
 */            
void from_mav_mission_request_list_callback(const mavlink_common::MISSION_REQUEST_LIST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_REQUEST_LIST request");
 ...
 *
 */            
void from_mav_mission_count_callback(const mavlink_common::MISSION_COUNT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_COUNT request");
 ...
 *
 */            
void from_mav_mission_clear_all_callback(const mavlink_common::MISSION_CLEAR_ALL::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_CLEAR_ALL request");
 ...
 *
 */            
void from_mav_mission_item_reached_callback(const mavlink_common::MISSION_ITEM_REACHED::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_ITEM_REACHED request");
 ...
 *
 */            
void from_mav_mission_ack_callback(const mavlink_common::MISSION_ACK::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MISSION_ACK request");
 ...
 *
 */            
void from_mav_set_gps_global_origin_callback(const mavlink_common::SET_GPS_GLOBAL_ORIGIN::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_GPS_GLOBAL_ORIGIN request");
 ...
 *
 */            
void from_mav_gps_global_origin_callback(const mavlink_common::GPS_GLOBAL_ORIGIN::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_GPS_GLOBAL_ORIGIN request");
 ...
 *
 */            
void from_mav_set_local_position_setpoint_callback(const mavlink_common::SET_LOCAL_POSITION_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_LOCAL_POSITION_SETPOINT request");
 ...
 *
 */            
void from_mav_local_position_setpoint_callback(const mavlink_common::LOCAL_POSITION_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_LOCAL_POSITION_SETPOINT request");
 ...
 *
 */            
void from_mav_global_position_setpoint_int_callback(const mavlink_common::GLOBAL_POSITION_SETPOINT_INT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_GLOBAL_POSITION_SETPOINT_INT request");
 ...
 *
 */            
void from_mav_set_global_position_setpoint_int_callback(const mavlink_common::SET_GLOBAL_POSITION_SETPOINT_INT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_GLOBAL_POSITION_SETPOINT_INT request");
 ...
 *
 */            
void from_mav_safety_set_allowed_area_callback(const mavlink_common::SAFETY_SET_ALLOWED_AREA::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SAFETY_SET_ALLOWED_AREA request");
 ...
 *
 */            
void from_mav_safety_allowed_area_callback(const mavlink_common::SAFETY_ALLOWED_AREA::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SAFETY_ALLOWED_AREA request");
 ...
 *
 */            
void from_mav_set_roll_pitch_yaw_thrust_callback(const mavlink_common::SET_ROLL_PITCH_YAW_THRUST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_ROLL_PITCH_YAW_THRUST request");
 ...
 *
 */            
void from_mav_set_roll_pitch_yaw_speed_thrust_callback(const mavlink_common::SET_ROLL_PITCH_YAW_SPEED_THRUST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_ROLL_PITCH_YAW_SPEED_THRUST request");
 ...
 *
 */            
void from_mav_roll_pitch_yaw_thrust_setpoint_callback(const mavlink_common::ROLL_PITCH_YAW_THRUST_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_ROLL_PITCH_YAW_THRUST_SETPOINT request");
 ...
 *
 */            
void from_mav_roll_pitch_yaw_speed_thrust_setpoint_callback(const mavlink_common::ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT request");
 ...
 *
 */            
void from_mav_set_quad_motors_setpoint_callback(const mavlink_common::SET_QUAD_MOTORS_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_QUAD_MOTORS_SETPOINT request");
 ...
 *
 */            
void from_mav_set_quad_swarm_roll_pitch_yaw_thrust_callback(const mavlink_common::SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST request");
 ...
 *
 */            
void from_mav_nav_controller_output_callback(const mavlink_common::NAV_CONTROLLER_OUTPUT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_NAV_CONTROLLER_OUTPUT request");
 ...
 *
 */            
void from_mav_set_quad_swarm_led_roll_pitch_yaw_thrust_callback(const mavlink_common::SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST request");
 ...
 *
 */            
void from_mav_state_correction_callback(const mavlink_common::STATE_CORRECTION::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_STATE_CORRECTION request");
 ...
 *
 */            
void from_mav_request_data_stream_callback(const mavlink_common::REQUEST_DATA_STREAM::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_REQUEST_DATA_STREAM request");
 ...
 *
 */            
void from_mav_data_stream_callback(const mavlink_common::DATA_STREAM::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_DATA_STREAM request");
 ...
 *
 */            
void from_mav_manual_control_callback(const mavlink_common::MANUAL_CONTROL::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MANUAL_CONTROL request");
 ...
 *
 */            
void from_mav_rc_channels_override_callback(const mavlink_common::RC_CHANNELS_OVERRIDE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_RC_CHANNELS_OVERRIDE request");
 ...
 *
 */            
void from_mav_vfr_hud_callback(const mavlink_common::VFR_HUD::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_VFR_HUD request");
 ...
 *
 */            
void from_mav_command_long_callback(const mavlink_common::COMMAND_LONG::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_COMMAND_LONG request");
 ...
 *
 */            
void from_mav_command_ack_callback(const mavlink_common::COMMAND_ACK::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_COMMAND_ACK request");
 ...
 *
 */            
void from_mav_roll_pitch_yaw_rates_thrust_setpoint_callback(const mavlink_common::ROLL_PITCH_YAW_RATES_THRUST_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_ROLL_PITCH_YAW_RATES_THRUST_SETPOINT request");
 ...
 *
 */            
void from_mav_manual_setpoint_callback(const mavlink_common::MANUAL_SETPOINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MANUAL_SETPOINT request");
 ...
 *
 */            
void from_mav_local_position_ned_system_global_offset_callback(const mavlink_common::LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET request");
 ...
 *
 */            
void from_mav_hil_state_callback(const mavlink_common::HIL_STATE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_HIL_STATE request");
 ...
 *
 */            
void from_mav_hil_controls_callback(const mavlink_common::HIL_CONTROLS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_HIL_CONTROLS request");
 ...
 *
 */            
void from_mav_hil_rc_inputs_raw_callback(const mavlink_common::HIL_RC_INPUTS_RAW::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_HIL_RC_INPUTS_RAW request");
 ...
 *
 */            
void from_mav_optical_flow_callback(const mavlink_common::OPTICAL_FLOW::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_OPTICAL_FLOW request");
 ...
 *
 */            
void from_mav_global_vision_position_estimate_callback(const mavlink_common::GLOBAL_VISION_POSITION_ESTIMATE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_GLOBAL_VISION_POSITION_ESTIMATE request");
 ...
 *
 */            
void from_mav_vision_position_estimate_callback(const mavlink_common::VISION_POSITION_ESTIMATE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_VISION_POSITION_ESTIMATE request");
 ...
 *
 */            
void from_mav_vision_speed_estimate_callback(const mavlink_common::VISION_SPEED_ESTIMATE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_VISION_SPEED_ESTIMATE request");
 ...
 *
 */            
void from_mav_vicon_position_estimate_callback(const mavlink_common::VICON_POSITION_ESTIMATE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_VICON_POSITION_ESTIMATE request");
 ...
 *
 */            
void from_mav_highres_imu_callback(const mavlink_common::HIGHRES_IMU::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_HIGHRES_IMU request");
 ...
 *
 */            
void from_mav_file_transfer_start_callback(const mavlink_common::FILE_TRANSFER_START::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_FILE_TRANSFER_START request");
 ...
 *
 */            
void from_mav_file_transfer_dir_list_callback(const mavlink_common::FILE_TRANSFER_DIR_LIST::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_FILE_TRANSFER_DIR_LIST request");
 ...
 *
 */            
void from_mav_file_transfer_res_callback(const mavlink_common::FILE_TRANSFER_RES::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_FILE_TRANSFER_RES request");
 ...
 *
 */            
void from_mav_battery_status_callback(const mavlink_common::BATTERY_STATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_BATTERY_STATUS request");
 ...
 *
 */            
void from_mav_setpoint_8dof_callback(const mavlink_common::SETPOINT_8DOF::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SETPOINT_8DOF request");
 ...
 *
 */            
void from_mav_setpoint_6dof_callback(const mavlink_common::SETPOINT_6DOF::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_SETPOINT_6DOF request");
 ...
 *
 */            
void from_mav_memory_vect_callback(const mavlink_common::MEMORY_VECT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_MEMORY_VECT request");
 ...
 *
 */            
void from_mav_debug_vect_callback(const mavlink_common::DEBUG_VECT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_DEBUG_VECT request");
 ...
 *
 */            
void from_mav_named_value_float_callback(const mavlink_common::NAMED_VALUE_FLOAT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_NAMED_VALUE_FLOAT request");
 ...
 *
 */            
void from_mav_named_value_int_callback(const mavlink_common::NAMED_VALUE_INT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_NAMED_VALUE_INT request");
 ...
 *
 */            
void from_mav_statustext_callback(const mavlink_common::STATUSTEXT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_STATUSTEXT request");
 ...
 *
 */            
void from_mav_debug_callback(const mavlink_common::DEBUG::ConstPtr& msg)
{
    ROS_INFO("[mavlink_common] Received a  'from_mav_DEBUG request");
 ...
 *
 */            
void from_mav_sensor_offsets_callback(const mavlink_ardupilotmega::SENSOR_OFFSETS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_SENSOR_OFFSETS request");
 ...
 *
 */            
void from_mav_set_mag_offsets_callback(const mavlink_ardupilotmega::SET_MAG_OFFSETS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_SET_MAG_OFFSETS request");
 ...
 *
 */            
void from_mav_meminfo_callback(const mavlink_ardupilotmega::MEMINFO::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_MEMINFO request");
 ...
 *
 */            
void from_mav_ap_adc_callback(const mavlink_ardupilotmega::AP_ADC::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_AP_ADC request");
 ...
 *
 */            
void from_mav_digicam_configure_callback(const mavlink_ardupilotmega::DIGICAM_CONFIGURE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_DIGICAM_CONFIGURE request");
 ...
 *
 */            
void from_mav_digicam_control_callback(const mavlink_ardupilotmega::DIGICAM_CONTROL::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_DIGICAM_CONTROL request");
 ...
 *
 */            
void from_mav_mount_configure_callback(const mavlink_ardupilotmega::MOUNT_CONFIGURE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_MOUNT_CONFIGURE request");
 ...
 *
 */            
void from_mav_mount_control_callback(const mavlink_ardupilotmega::MOUNT_CONTROL::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_MOUNT_CONTROL request");
 ...
 *
 */            
void from_mav_mount_status_callback(const mavlink_ardupilotmega::MOUNT_STATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_MOUNT_STATUS request");
 ...
 *
 */            
void from_mav_fence_point_callback(const mavlink_ardupilotmega::FENCE_POINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_FENCE_POINT request");
 ...
 *
 */            
void from_mav_fence_fetch_point_callback(const mavlink_ardupilotmega::FENCE_FETCH_POINT::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_FENCE_FETCH_POINT request");
 ...
 *
 */            
void from_mav_fence_status_callback(const mavlink_ardupilotmega::FENCE_STATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_FENCE_STATUS request");
 ...
 *
 */            
void from_mav_ahrs_callback(const mavlink_ardupilotmega::AHRS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_AHRS request");
 ...
 *
 */            
void from_mav_simstate_callback(const mavlink_ardupilotmega::SIMSTATE::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_SIMSTATE request");
 ...
 *
 */            
void from_mav_hwstatus_callback(const mavlink_ardupilotmega::HWSTATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_HWSTATUS request");
 ...
 *
 */            
void from_mav_radio_callback(const mavlink_ardupilotmega::RADIO::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_RADIO request");
 ...
 *
 */            
void from_mav_limits_status_callback(const mavlink_ardupilotmega::LIMITS_STATUS::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_LIMITS_STATUS request");
 ...
 *
 */            
void from_mav_wind_callback(const mavlink_ardupilotmega::WIND::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_WIND request");
 ...
 *
 */            
void from_mav_data16_callback(const mavlink_ardupilotmega::DATA16::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_DATA16 request");
 ...
 *
 */            
void from_mav_data32_callback(const mavlink_ardupilotmega::DATA32::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_DATA32 request");
 ...
 *
 */            
void from_mav_data64_callback(const mavlink_ardupilotmega::DATA64::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_DATA64 request");
 ...
 *
 */            
void from_mav_data96_callback(const mavlink_ardupilotmega::DATA96::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'from_mav_DATA96 request");
 ...
 *
 */ 
void from_qgc_mav_raw_data_callback(const mavlink_ardupilotmega::MAV_RAW_DATA::ConstPtr& msg)
{
    ROS_INFO("[mavlink_ardupilotmega] Received a  'qgc_mav_mav_raw_data_callback request");
	...
	m.mavlink_version = heartbeat_in.mavlink_version;
                        ...
                        to_mav_heartbeat_pub.publish(m);     
                    }
                    break;
	...
	m.errors_count4 = sys_status_in.errors_count4;
                        ...
                        to_mav_sys_status_pub.publish(m);     
                    }
                    break;
	...
	m.time_boot_ms = system_time_in.time_boot_ms;
                        ...
                        to_mav_system_time_pub.publish(m);     
                    }
                    break;
	...
	memcpy(&(m.passkey), &(change_operator_control_in.passkey), sizeof(char)*25);
                        ...
                        to_mav_change_operator_control_pub.publish(m);     
                    }
                    break;
	...
	m.ack = change_operator_control_ack_in.ack;
                        ...
                        to_mav_change_operator_control_ack_pub.publish(m);     
                    }
                    break;
	...
	m.param_index = param_request_read_in.param_index;
                        ...
                        to_mav_param_request_read_pub.publish(m);     
                    }
                    break;
	...
	m.target_component = param_request_list_in.target_component;
                        ...
                        to_mav_param_request_list_pub.publish(m);     
                    }
                    break;
	...
	m.param_index = param_value_in.param_index;
                        ...
                        to_mav_param_value_pub.publish(m);     
                    }
                    break;
	...
	m.param_type = param_set_in.param_type;
                        ...
                        to_mav_param_set_pub.publish(m);     
                    }
                    break;
	...
	m.satellites_visible = gps_raw_int_in.satellites_visible;
                        ...
                        to_mav_gps_raw_int_pub.publish(m);     
                    }
                    break;
	...
	memcpy(&(m.satellite_snr), &(gps_status_in.satellite_snr), sizeof(uint8_t)*20);
                        ...
                        to_mav_gps_status_pub.publish(m);     
                    }
                    break;
	...
	m.zmag = scaled_imu_in.zmag;
                        ...
                        to_mav_scaled_imu_pub.publish(m);     
                    }
                    break;
	...
	m.temperature = raw_pressure_in.temperature;
                        ...
                        to_mav_raw_pressure_pub.publish(m);     
                    }
                    break;
	...
	m.temperature = scaled_pressure_in.temperature;
                        ...
                        to_mav_scaled_pressure_pub.publish(m);     
                    }
                    break;
	...
	m.yawspeed = attitude_quaternion_in.yawspeed;
                        ...
                        to_mav_attitude_quaternion_pub.publish(m);     
                    }
                    break;
	...
	m.vz = local_position_ned_in.vz;
                        ...
                        to_mav_local_position_ned_pub.publish(m);     
                    }
                    break;
	...
	m.hdg = global_position_int_in.hdg;
                        ...
                        to_mav_global_position_int_pub.publish(m);     
                    }
                    break;
	...
	m.rssi = rc_channels_scaled_in.rssi;
                        ...
                        to_mav_rc_channels_scaled_pub.publish(m);     
                    }
                    break;
	...
	m.rssi = rc_channels_raw_in.rssi;
                        ...
                        to_mav_rc_channels_raw_pub.publish(m);     
                    }
                    break;
	...
	m.servo8_raw = servo_output_raw_in.servo8_raw;
                        ...
                        to_mav_servo_output_raw_pub.publish(m);     
                    }
                    break;
	...
	m.end_index = mission_request_partial_list_in.end_index;
                        ...
                        to_mav_mission_request_partial_list_pub.publish(m);     
                    }
                    break;
	...
	m.end_index = mission_write_partial_list_in.end_index;
                        ...
                        to_mav_mission_write_partial_list_pub.publish(m);     
                    }
                    break;
	...
	m.z = mission_item_in.z;
                        ...
                        to_mav_mission_item_pub.publish(m);     
                    }
                    break;
	...
	m.seq = mission_request_in.seq;
                        ...
                        to_mav_mission_request_pub.publish(m);     
                    }
                    break;
	...
	m.seq = mission_set_current_in.seq;
                        ...
                        to_mav_mission_set_current_pub.publish(m);     
                    }
                    break;
                    case MAVLINK_MSG_ID_MISSION_CURRENT:
                    {
                        ...
                        to_mav_mission_current_pub.publish(m);     
                    }
                    break;
	...
	m.target_component = mission_request_list_in.target_component;
                        ...
                        to_mav_mission_request_list_pub.publish(m);     
                    }
                    break;
	...
	m.count = mission_count_in.count;
                        ...
                        to_mav_mission_count_pub.publish(m);     
                    }
                    break;
	...
	m.target_component = mission_clear_all_in.target_component;
                        ...
                        to_mav_mission_clear_all_pub.publish(m);     
                    }
                    break;
                    case MAVLINK_MSG_ID_MISSION_ITEM_REACHED:
                    {
                        ...
                        to_mav_mission_item_reached_pub.publish(m);     
                    }
                    break;
	...
	m.type = mission_ack_in.type;
                        ...
                        to_mav_mission_ack_pub.publish(m);     
                    }
                    break;
	...
	m.altitude = set_gps_global_origin_in.altitude;
                        ...
                        to_mav_set_gps_global_origin_pub.publish(m);     
                    }
                    break;
	...
	m.altitude = gps_global_origin_in.altitude;
                        ...
                        to_mav_gps_global_origin_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = set_local_position_setpoint_in.yaw;
                        ...
                        to_mav_set_local_position_setpoint_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = local_position_setpoint_in.yaw;
                        ...
                        to_mav_local_position_setpoint_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = global_position_setpoint_int_in.yaw;
                        ...
                        to_mav_global_position_setpoint_int_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = set_global_position_setpoint_int_in.yaw;
                        ...
                        to_mav_set_global_position_setpoint_int_pub.publish(m);     
                    }
                    break;
	...
	m.p2z = safety_set_allowed_area_in.p2z;
                        ...
                        to_mav_safety_set_allowed_area_pub.publish(m);     
                    }
                    break;
	...
	m.p2z = safety_allowed_area_in.p2z;
                        ...
                        to_mav_safety_allowed_area_pub.publish(m);     
                    }
                    break;
	...
	m.thrust = set_roll_pitch_yaw_thrust_in.thrust;
                        ...
                        to_mav_set_roll_pitch_yaw_thrust_pub.publish(m);     
                    }
                    break;
	...
	m.thrust = set_roll_pitch_yaw_speed_thrust_in.thrust;
                        ...
                        to_mav_set_roll_pitch_yaw_speed_thrust_pub.publish(m);     
                    }
                    break;
	...
	m.thrust = roll_pitch_yaw_thrust_setpoint_in.thrust;
                        ...
                        to_mav_roll_pitch_yaw_thrust_setpoint_pub.publish(m);     
                    }
                    break;
	...
	m.thrust = roll_pitch_yaw_speed_thrust_setpoint_in.thrust;
                        ...
                        to_mav_roll_pitch_yaw_speed_thrust_setpoint_pub.publish(m);     
                    }
                    break;
	...
	m.motor_left_sw = set_quad_motors_setpoint_in.motor_left_sw;
                        ...
                        to_mav_set_quad_motors_setpoint_pub.publish(m);     
                    }
                    break;
	...
	memcpy(&(m.thrust), &(set_quad_swarm_roll_pitch_yaw_thrust_in.thrust), sizeof(uint16_t)*4);
                        ...
                        to_mav_set_quad_swarm_roll_pitch_yaw_thrust_pub.publish(m);     
                    }
                    break;
	...
	m.xtrack_error = nav_controller_output_in.xtrack_error;
                        ...
                        to_mav_nav_controller_output_pub.publish(m);     
                    }
                    break;
	...
	memcpy(&(m.thrust), &(set_quad_swarm_led_roll_pitch_yaw_thrust_in.thrust), sizeof(uint16_t)*4);
                        ...
                        to_mav_set_quad_swarm_led_roll_pitch_yaw_thrust_pub.publish(m);     
                    }
                    break;
	...
	m.vzErr = state_correction_in.vzErr;
                        ...
                        to_mav_state_correction_pub.publish(m);     
                    }
                    break;
	...
	m.start_stop = request_data_stream_in.start_stop;
                        ...
                        to_mav_request_data_stream_pub.publish(m);     
                    }
                    break;
	...
	m.on_off = data_stream_in.on_off;
                        ...
                        to_mav_data_stream_pub.publish(m);     
                    }
                    break;
	...
	m.buttons = manual_control_in.buttons;
                        ...
                        to_mav_manual_control_pub.publish(m);     
                    }
                    break;
	...
	m.chan8_raw = rc_channels_override_in.chan8_raw;
                        ...
                        to_mav_rc_channels_override_pub.publish(m);     
                    }
                    break;
	...
	m.param7 = command_long_in.param7;
                        ...
                        to_mav_command_long_pub.publish(m);     
                    }
                    break;
	...
	m.result = command_ack_in.result;
                        ...
                        to_mav_command_ack_pub.publish(m);     
                    }
                    break;
	...
	m.thrust = roll_pitch_yaw_rates_thrust_setpoint_in.thrust;
                        ...
                        to_mav_roll_pitch_yaw_rates_thrust_setpoint_pub.publish(m);     
                    }
                    break;
	...
	m.manual_override_switch = manual_setpoint_in.manual_override_switch;
                        ...
                        to_mav_manual_setpoint_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = local_position_ned_system_global_offset_in.yaw;
                        ...
                        to_mav_local_position_ned_system_global_offset_pub.publish(m);     
                    }
                    break;
	...
	m.zacc = hil_state_in.zacc;
                        ...
                        to_mav_hil_state_pub.publish(m);     
                    }
                    break;
	...
	m.nav_mode = hil_controls_in.nav_mode;
                        ...
                        to_mav_hil_controls_pub.publish(m);     
                    }
                    break;
	...
	m.rssi = hil_rc_inputs_raw_in.rssi;
                        ...
                        to_mav_hil_rc_inputs_raw_pub.publish(m);     
                    }
                    break;
	...
	m.ground_distance = optical_flow_in.ground_distance;
                        ...
                        to_mav_optical_flow_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = global_vision_position_estimate_in.yaw;
                        ...
                        to_mav_global_vision_position_estimate_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = vision_position_estimate_in.yaw;
                        ...
                        to_mav_vision_position_estimate_pub.publish(m);     
                    }
                    break;
	...
	m.z = vision_speed_estimate_in.z;
                        ...
                        to_mav_vision_speed_estimate_pub.publish(m);     
                    }
                    break;
	...
	m.yaw = vicon_position_estimate_in.yaw;
                        ...
                        to_mav_vicon_position_estimate_pub.publish(m);     
                    }
                    break;
	...
	m.fields_updated = highres_imu_in.fields_updated;
                        ...
                        to_mav_highres_imu_pub.publish(m);     
                    }
                    break;
	...
	m.flags = file_transfer_start_in.flags;
                        ...
                        to_mav_file_transfer_start_pub.publish(m);     
                    }
                    break;
	...
	m.flags = file_transfer_dir_list_in.flags;
                        ...
                        to_mav_file_transfer_dir_list_pub.publish(m);     
                    }
                    break;
	...
	m.result = file_transfer_res_in.result;
                        ...
                        to_mav_file_transfer_res_pub.publish(m);     
                    }
                    break;
	...
	m.battery_remaining = battery_status_in.battery_remaining;
                        ...
                        to_mav_battery_status_pub.publish(m);     
                    }
                    break;
	...
	m.val8 = setpoint_8dof_in.val8;
                        ...
                        to_mav_setpoint_8dof_pub.publish(m);     
                    }
                    break;
	...
	m.rot_z = setpoint_6dof_in.rot_z;
                        ...
                        to_mav_setpoint_6dof_pub.publish(m);     
                    }
                    break;
	...
	memcpy(&(m.value), &(memory_vect_in.value), sizeof(int8_t)*32);
                        ...
                        to_mav_memory_vect_pub.publish(m);     
                    }
                    break;
	...
	m.z = debug_vect_in.z;
                        ...
                        to_mav_debug_vect_pub.publish(m);     
                    }
                    break;
	...
	m.value = named_value_float_in.value;
                        ...
                        to_mav_named_value_float_pub.publish(m);     
                    }
                    break;
	...
	m.value = named_value_int_in.value;
                        ...
                        to_mav_named_value_int_pub.publish(m);     
                    }
                    break;
	...
	memcpy(&(m.text), &(statustext_in.text), sizeof(char)*50);
                        ...
                        to_mav_statustext_pub.publish(m);     
                    }
                    break;
	...
	m.accel_cal_z = sensor_offsets_in.accel_cal_z;
                        ...
                        to_mav_sensor_offsets_pub.publish(m);     
                    }
                    break;
	...
	m.mag_ofs_z = set_mag_offsets_in.mag_ofs_z;
                        ...
                        to_mav_set_mag_offsets_pub.publish(m);     
                    }
                    break;
	...
	m.extra_value = digicam_configure_in.extra_value;
                        ...
                        to_mav_digicam_configure_pub.publish(m);     
                    }
                    break;
	...
	m.extra_value = digicam_control_in.extra_value;
                        ...
                        to_mav_digicam_control_pub.publish(m);     
                    }
                    break;
	...
	m.stab_yaw = mount_configure_in.stab_yaw;
                        ...
                        to_mav_mount_configure_pub.publish(m);     
                    }
                    break;
	...
	m.save_position = mount_control_in.save_position;
                        ...
                        to_mav_mount_control_pub.publish(m);     
                    }
                    break;
	...
	m.pointing_c = mount_status_in.pointing_c;
                        ...
                        to_mav_mount_status_pub.publish(m);     
                    }
                    break;
	...
	m.lng = fence_point_in.lng;
                        ...
                        to_mav_fence_point_pub.publish(m);     
                    }
                    break;
	...
	m.idx = fence_fetch_point_in.idx;
                        ...
                        to_mav_fence_fetch_point_pub.publish(m);     
                    }
                    break;
	...
	m.breach_time = fence_status_in.breach_time;
                        ...
                        to_mav_fence_status_pub.publish(m);     
                    }
                    break;
	...
	m.mods_triggered = limits_status_in.mods_triggered;
                        ...
                        to_mav_limits_status_pub.publish(m);     
                    }
                    break;
...
int main(int argc, char **argv)
{
    ...
    to_qgc_mav_raw_data_publisher     = n.advertise<mavlink_ardupilotmega::MAV_RAW_DATA>("/to_qgc_mav_raw_data", 10);
    from_qgc_mav_raw_data_subscriber  = n.subscribe("/from_qgc_mav_raw_data", 10, from_qgc_mav_raw_data_callback);

    /**
     * Messages Publishers Initialization
     */
	to_mav_heartbeat_pub = n.advertise<mavlink_common::HEARTBEAT>("/to_mav_heartbeat", 10);
	to_mav_sys_status_pub = n.advertise<mavlink_common::SYS_STATUS>("/to_mav_sys_status", 10);
	to_mav_system_time_pub = n.advertise<mavlink_common::SYSTEM_TIME>("/to_mav_system_time", 10);
	to_mav_ping_pub = n.advertise<mavlink_common::PING>("/to_mav_ping", 10);
	to_mav_change_operator_control_pub = n.advertise<mavlink_common::CHANGE_OPERATOR_CONTROL>("/to_mav_change_operator_control", 10);
	to_mav_change_operator_control_ack_pub = n.advertise<mavlink_common::CHANGE_OPERATOR_CONTROL_ACK>("/to_mav_change_operator_control_ack", 10);
	to_mav_auth_key_pub = n.advertise<mavlink_common::AUTH_KEY>("/to_mav_auth_key", 10);
	to_mav_set_mode_pub = n.advertise<mavlink_common::SET_MODE>("/to_mav_set_mode", 10);
	to_mav_param_request_read_pub = n.advertise<mavlink_common::PARAM_REQUEST_READ>("/to_mav_param_request_read", 10);
	to_mav_param_request_list_pub = n.advertise<mavlink_common::PARAM_REQUEST_LIST>("/to_mav_param_request_list", 10);
	to_mav_param_value_pub = n.advertise<mavlink_common::PARAM_VALUE>("/to_mav_param_value", 10);
	to_mav_param_set_pub = n.advertise<mavlink_common::PARAM_SET>("/to_mav_param_set", 10);
	to_mav_gps_raw_int_pub = n.advertise<mavlink_common::GPS_RAW_INT>("/to_mav_gps_raw_int", 10);
	to_mav_gps_status_pub = n.advertise<mavlink_common::GPS_STATUS>("/to_mav_gps_status", 10);
	to_mav_scaled_imu_pub = n.advertise<mavlink_common::SCALED_IMU>("/to_mav_scaled_imu", 10);
	to_mav_raw_imu_pub = n.advertise<mavlink_common::RAW_IMU>("/to_mav_raw_imu", 10);
	to_mav_raw_pressure_pub = n.advertise<mavlink_common::RAW_PRESSURE>("/to_mav_raw_pressure", 10);
	to_mav_scaled_pressure_pub = n.advertise<mavlink_common::SCALED_PRESSURE>("/to_mav_scaled_pressure", 10);
	to_mav_attitude_pub = n.advertise<mavlink_common::ATTITUDE>("/to_mav_attitude", 10);
	to_mav_attitude_quaternion_pub = n.advertise<mavlink_common::ATTITUDE_QUATERNION>("/to_mav_attitude_quaternion", 10);
	to_mav_local_position_ned_pub = n.advertise<mavlink_common::LOCAL_POSITION_NED>("/to_mav_local_position_ned", 10);
	to_mav_global_position_int_pub = n.advertise<mavlink_common::GLOBAL_POSITION_INT>("/to_mav_global_position_int", 10);
	to_mav_rc_channels_scaled_pub = n.advertise<mavlink_common::RC_CHANNELS_SCALED>("/to_mav_rc_channels_scaled", 10);
	to_mav_rc_channels_raw_pub = n.advertise<mavlink_common::RC_CHANNELS_RAW>("/to_mav_rc_channels_raw", 10);
	to_mav_servo_output_raw_pub = n.advertise<mavlink_common::SERVO_OUTPUT_RAW>("/to_mav_servo_output_raw", 10);
	to_mav_mission_request_partial_list_pub = n.advertise<mavlink_common::MISSION_REQUEST_PARTIAL_LIST>("/to_mav_mission_request_partial_list", 10);
	to_mav_mission_write_partial_list_pub = n.advertise<mavlink_common::MISSION_WRITE_PARTIAL_LIST>("/to_mav_mission_write_partial_list", 10);
	to_mav_mission_item_pub = n.advertise<mavlink_common::MISSION_ITEM>("/to_mav_mission_item", 10);
	to_mav_mission_request_pub = n.advertise<mavlink_common::MISSION_REQUEST>("/to_mav_mission_request", 10);
	to_mav_mission_set_current_pub = n.advertise<mavlink_common::MISSION_SET_CURRENT>("/to_mav_mission_set_current", 10);
	to_mav_mission_current_pub = n.advertise<mavlink_common::MISSION_CURRENT>("/to_mav_mission_current", 10);
	to_mav_mission_request_list_pub = n.advertise<mavlink_common::MISSION_REQUEST_LIST>("/to_mav_mission_request_list", 10);
	to_mav_mission_count_pub = n.advertise<mavlink_common::MISSION_COUNT>("/to_mav_mission_count", 10);
	to_mav_mission_clear_all_pub = n.advertise<mavlink_common::MISSION_CLEAR_ALL>("/to_mav_mission_clear_all", 10);
	to_mav_mission_item_reached_pub = n.advertise<mavlink_common::MISSION_ITEM_REACHED>("/to_mav_mission_item_reached", 10);
	to_mav_mission_ack_pub = n.advertise<mavlink_common::MISSION_ACK>("/to_mav_mission_ack", 10);
	to_mav_set_gps_global_origin_pub = n.advertise<mavlink_common::SET_GPS_GLOBAL_ORIGIN>("/to_mav_set_gps_global_origin", 10);
	to_mav_gps_global_origin_pub = n.advertise<mavlink_common::GPS_GLOBAL_ORIGIN>("/to_mav_gps_global_origin", 10);
	to_mav_set_local_position_setpoint_pub = n.advertise<mavlink_common::SET_LOCAL_POSITION_SETPOINT>("/to_mav_set_local_position_setpoint", 10);
	to_mav_local_position_setpoint_pub = n.advertise<mavlink_common::LOCAL_POSITION_SETPOINT>("/to_mav_local_position_setpoint", 10);
	to_mav_global_position_setpoint_int_pub = n.advertise<mavlink_common::GLOBAL_POSITION_SETPOINT_INT>("/to_mav_global_position_setpoint_int", 10);
	to_mav_set_global_position_setpoint_int_pub = n.advertise<mavlink_common::SET_GLOBAL_POSITION_SETPOINT_INT>("/to_mav_set_global_position_setpoint_int", 10);
	to_mav_safety_set_allowed_area_pub = n.advertise<mavlink_common::SAFETY_SET_ALLOWED_AREA>("/to_mav_safety_set_allowed_area", 10);
	to_mav_safety_allowed_area_pub = n.advertise<mavlink_common::SAFETY_ALLOWED_AREA>("/to_mav_safety_allowed_area", 10);
	to_mav_set_roll_pitch_yaw_thrust_pub = n.advertise<mavlink_common::SET_ROLL_PITCH_YAW_THRUST>("/to_mav_set_roll_pitch_yaw_thrust", 10);
	to_mav_set_roll_pitch_yaw_speed_thrust_pub = n.advertise<mavlink_common::SET_ROLL_PITCH_YAW_SPEED_THRUST>("/to_mav_set_roll_pitch_yaw_speed_thrust", 10);
	to_mav_roll_pitch_yaw_thrust_setpoint_pub = n.advertise<mavlink_common::ROLL_PITCH_YAW_THRUST_SETPOINT>("/to_mav_roll_pitch_yaw_thrust_setpoint", 10);
	to_mav_roll_pitch_yaw_speed_thrust_setpoint_pub = n.advertise<mavlink_common::ROLL_PITCH_YAW_SPEED_THRUST_SETPOINT>("/to_mav_roll_pitch_yaw_speed_thrust_setpoint", 10);
	to_mav_set_quad_motors_setpoint_pub = n.advertise<mavlink_common::SET_QUAD_MOTORS_SETPOINT>("/to_mav_set_quad_motors_setpoint", 10);
	to_mav_set_quad_swarm_roll_pitch_yaw_thrust_pub = n.advertise<mavlink_common::SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST>("/to_mav_set_quad_swarm_roll_pitch_yaw_thrust", 10);
	to_mav_nav_controller_output_pub = n.advertise<mavlink_common::NAV_CONTROLLER_OUTPUT>("/to_mav_nav_controller_output", 10);
	to_mav_set_quad_swarm_led_roll_pitch_yaw_thrust_pub = n.advertise<mavlink_common::SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST>("/to_mav_set_quad_swarm_led_roll_pitch_yaw_thrust", 10);
	to_mav_state_correction_pub = n.advertise<mavlink_common::STATE_CORRECTION>("/to_mav_state_correction", 10);
	to_mav_request_data_stream_pub = n.advertise<mavlink_common::REQUEST_DATA_STREAM>("/to_mav_request_data_stream", 10);
	to_mav_data_stream_pub = n.advertise<mavlink_common::DATA_STREAM>("/to_mav_data_stream", 10);
	to_mav_manual_control_pub = n.advertise<mavlink_common::MANUAL_CONTROL>("/to_mav_manual_control", 10);
	to_mav_rc_channels_override_pub = n.advertise<mavlink_common::RC_CHANNELS_OVERRIDE>("/to_mav_rc_channels_override", 10);
	to_mav_vfr_hud_pub = n.advertise<mavlink_common::VFR_HUD>("/to_mav_vfr_hud", 10);
	to_mav_command_long_pub = n.advertise<mavlink_common::COMMAND_LONG>("/to_mav_command_long", 10);
	to_mav_command_ack_pub = n.advertise<mavlink_common::COMMAND_ACK>("/to_mav_command_ack", 10);
	to_mav_roll_pitch_yaw_rates_thrust_setpoint_pub = n.advertise<mavlink_common::ROLL_PITCH_YAW_RATES_THRUST_SETPOINT>("/to_mav_roll_pitch_yaw_rates_thrust_setpoint", 10);
	to_mav_manual_setpoint_pub = n.advertise<mavlink_common::MANUAL_SETPOINT>("/to_mav_manual_setpoint", 10);
	to_mav_local_position_ned_system_global_offset_pub = n.advertise<mavlink_common::LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET>("/to_mav_local_position_ned_system_global_offset", 10);
	to_mav_hil_state_pub = n.advertise<mavlink_common::HIL_STATE>("/to_mav_hil_state", 10);
	to_mav_hil_controls_pub = n.advertise<mavlink_common::HIL_CONTROLS>("/to_mav_hil_controls", 10);
	to_mav_hil_rc_inputs_raw_pub = n.advertise<mavlink_common::HIL_RC_INPUTS_RAW>("/to_mav_hil_rc_inputs_raw", 10);
	to_mav_optical_flow_pub = n.advertise<mavlink_common::OPTICAL_FLOW>("/to_mav_optical_flow", 10);
	to_mav_global_vision_position_estimate_pub = n.advertise<mavlink_common::GLOBAL_VISION_POSITION_ESTIMATE>("/to_mav_global_vision_position_estimate", 10);
	to_mav_vision_position_estimate_pub = n.advertise<mavlink_common::VISION_POSITION_ESTIMATE>("/to_mav_vision_position_estimate", 10);
	to_mav_vision_speed_estimate_pub = n.advertise<mavlink_common::VISION_SPEED_ESTIMATE>("/to_mav_vision_speed_estimate", 10);
	to_mav_vicon_position_estimate_pub = n.advertise<mavlink_common::VICON_POSITION_ESTIMATE>("/to_mav_vicon_position_estimate", 10);
	to_mav_highres_imu_pub = n.advertise<mavlink_common::HIGHRES_IMU>("/to_mav_highres_imu", 10);
	to_mav_file_transfer_start_pub = n.advertise<mavlink_common::FILE_TRANSFER_START>("/to_mav_file_transfer_start", 10);
	to_mav_file_transfer_dir_list_pub = n.advertise<mavlink_common::FILE_TRANSFER_DIR_LIST>("/to_mav_file_transfer_dir_list", 10);
	to_mav_file_transfer_res_pub = n.advertise<mavlink_common::FILE_TRANSFER_RES>("/to_mav_file_transfer_res", 10);
	to_mav_battery_status_pub = n.advertise<mavlink_common::BATTERY_STATUS>("/to_mav_battery_status", 10);
	to_mav_setpoint_8dof_pub = n.advertise<mavlink_common::SETPOINT_8DOF>("/to_mav_setpoint_8dof", 10);
	to_mav_setpoint_6dof_pub = n.advertise<mavlink_common::SETPOINT_6DOF>("/to_mav_setpoint_6dof", 10);
	to_mav_memory_vect_pub = n.advertise<mavlink_common::MEMORY_VECT>("/to_mav_memory_vect", 10);
	to_mav_debug_vect_pub = n.advertise<mavlink_common::DEBUG_VECT>("/to_mav_debug_vect", 10);
	to_mav_named_value_float_pub = n.advertise<mavlink_common::NAMED_VALUE_FLOAT>("/to_mav_named_value_float", 10);
	to_mav_named_value_int_pub = n.advertise<mavlink_common::NAMED_VALUE_INT>("/to_mav_named_value_int", 10);
	to_mav_statustext_pub = n.advertise<mavlink_common::STATUSTEXT>("/to_mav_statustext", 10);
	to_mav_debug_pub = n.advertise<mavlink_common::DEBUG>("/to_mav_debug", 10);
	to_mav_sensor_offsets_pub = n.advertise<mavlink_ardupilotmega::SENSOR_OFFSETS>("/to_mav_sensor_offsets", 10);
	to_mav_set_mag_offsets_pub = n.advertise<mavlink_ardupilotmega::SET_MAG_OFFSETS>("/to_mav_set_mag_offsets", 10);
	to_mav_meminfo_pub = n.advertise<mavlink_ardupilotmega::MEMINFO>("/to_mav_meminfo", 10);
	to_mav_ap_adc_pub = n.advertise<mavlink_ardupilotmega::AP_ADC>("/to_mav_ap_adc", 10);
	to_mav_digicam_configure_pub = n.advertise<mavlink_ardupilotmega::DIGICAM_CONFIGURE>("/to_mav_digicam_configure", 10);
	to_mav_digicam_control_pub = n.advertise<mavlink_ardupilotmega::DIGICAM_CONTROL>("/to_mav_digicam_control", 10);
	to_mav_mount_configure_pub = n.advertise<mavlink_ardupilotmega::MOUNT_CONFIGURE>("/to_mav_mount_configure", 10);
	to_mav_mount_control_pub = n.advertise<mavlink_ardupilotmega::MOUNT_CONTROL>("/to_mav_mount_control", 10);
	to_mav_mount_status_pub = n.advertise<mavlink_ardupilotmega::MOUNT_STATUS>("/to_mav_mount_status", 10);
	to_mav_fence_point_pub = n.advertise<mavlink_ardupilotmega::FENCE_POINT>("/to_mav_fence_point", 10);
	to_mav_fence_fetch_point_pub = n.advertise<mavlink_ardupilotmega::FENCE_FETCH_POINT>("/to_mav_fence_fetch_point", 10);
	to_mav_fence_status_pub = n.advertise<mavlink_ardupilotmega::FENCE_STATUS>("/to_mav_fence_status", 10);
	to_mav_ahrs_pub = n.advertise<mavlink_ardupilotmega::AHRS>("/to_mav_ahrs", 10);
	to_mav_simstate_pub = n.advertise<mavlink_ardupilotmega::SIMSTATE>("/to_mav_simstate", 10);
	to_mav_hwstatus_pub = n.advertise<mavlink_ardupilotmega::HWSTATUS>("/to_mav_hwstatus", 10);
	to_mav_radio_pub = n.advertise<mavlink_ardupilotmega::RADIO>("/to_mav_radio", 10);
	to_mav_limits_status_pub = n.advertise<mavlink_ardupilotmega::LIMITS_STATUS>("/to_mav_limits_status", 10);
	to_mav_wind_pub = n.advertise<mavlink_ardupilotmega::WIND>("/to_mav_wind", 10);
	to_mav_data16_pub = n.advertise<mavlink_ardupilotmega::DATA16>("/to_mav_data16", 10);
	to_mav_data32_pub = n.advertise<mavlink_ardupilotmega::DATA32>("/to_mav_data32", 10);
	to_mav_data64_pub = n.advertise<mavlink_ardupilotmega::DATA64>("/to_mav_data64", 10);
	to_mav_data96_pub = n.advertise<mavlink_ardupilotmega::DATA96>("/to_mav_data96", 10);

    /**
     * Messages Subscribers Declaration
     */
	ros::Subscriber from_mav_heartbeat_sub = n.subscribe("/from_mav_heartbeat", 10, from_mav_heartbeat_callback);
	ros::Subscriber from_mav_sys_status_sub = n.subscribe("/from_mav_sys_status", 10, from_mav_sys_status_callback);
	ros::Subscriber from_mav_system_time_sub = n.subscribe("/from_mav_system_time", 10, from_mav_system_time_callback);
	ros::Subscriber from_mav_ping_sub = n.subscribe("/from_mav_ping", 10, from_mav_ping_callback);
	ros::Subscriber from_mav_change_operator_control_sub = n.subscribe("/from_mav_change_operator_control", 10, from_mav_change_operator_control_callback);
	ros::Subscriber from_mav_change_operator_control_ack_sub = n.subscribe("/from_mav_change_operator_control_ack", 10, from_mav_change_operator_control_ack_callback);
	ros::Subscriber from_mav_auth_key_sub = n.subscribe("/from_mav_auth_key", 10, from_mav_auth_key_callback);
	ros::Subscriber from_mav_set_mode_sub = n.subscribe("/from_mav_set_mode", 10, from_mav_set_mode_callback);
	ros::Subscriber from_mav_param_request_read_sub = n.subscribe("/from_mav_param_request_read", 10, from_mav_param_request_read_callback);
	ros::Subscriber from_mav_param_request_list_sub = n.subscribe("/from_mav_param_request_list", 10, from_mav_param_request_list_callback);
	ros::Subscriber from_mav_param_value_sub = n.subscribe("/from_mav_param_value", 10, from_mav_param_value_callback);
	ros::Subscriber from_mav_param_set_sub = n.subscribe("/from_mav_param_set", 10, from_mav_param_set_callback);
	ros::Subscriber from_mav_gps_raw_int_sub = n.subscribe("/from_mav_gps_raw_int", 10, from_mav_gps_raw_int_callback);
	ros::Subscriber from_mav_gps_status_sub = n.subscribe("/from_mav_gps_status", 10, from_mav_gps_status_callback);
	ros::Subscriber from_mav_scaled_imu_sub = n.subscribe("/from_mav_scaled_imu", 10, from_mav_scaled_imu_callback);
	ros::Subscriber from_mav_raw_imu_sub = n.subscribe("/from_mav_raw_imu", 10, from_mav_raw_imu_callback);
	ros::Subscriber from_mav_raw_pressure_sub = n.subscribe("/from_mav_raw_pressure", 10, from_mav_raw_pressure_callback);
	ros::Subscriber from_mav_scaled_pressure_sub = n.subscribe("/from_mav_scaled_pressure", 10, from_mav_scaled_pressure_callback);
	ros::Subscriber from_mav_attitude_sub = n.subscribe("/from_mav_attitude", 10, from_mav_attitude_callback);
	ros::Subscriber from_mav_attitude_quaternion_sub = n.subscribe("/from_mav_attitude_quaternion", 10, from_mav_attitude_quaternion_callback);
	ros::Subscriber from_mav_local_position_ned_sub = n.subscribe("/from_mav_local_position_ned", 10, from_mav_local_position_ned_callback);
	ros::Subscriber from_mav_global_position_int_sub = n.subscribe("/from_mav_global_position_int", 10, from_mav_global_position_int_callback);
	ros::Subscriber from_mav_rc_channels_scaled_sub = n.subscribe("/from_mav_rc_channels_scaled", 10, from_mav_rc_channels_scaled_callback);
	ros::Subscriber from_mav_rc_channels_raw_sub = n.subscribe("/from_mav_rc_channels_raw", 10, from_mav_rc_channels_raw_callback);
	ros::Subscriber from_mav_servo_output_raw_sub = n.subscribe("/from_mav_servo_output_raw", 10, from_mav_servo_output_raw_callback);
	ros::Subscriber from_mav_mission_request_partial_list_sub = n.subscribe("/from_mav_mission_request_partial_list", 10, from_mav_mission_request_partial_list_callback);
	ros::Subscriber from_mav_mission_write_partial_list_sub = n.subscribe("/from_mav_mission_write_partial_list", 10, from_mav_mission_write_partial_list_callback);
	ros::Subscriber from_mav_mission_item_sub = n.subscribe("/from_mav_mission_item", 10, from_mav_mission_item_callback);
	ros::Subscriber from_mav_mission_request_sub = n.subscribe("/from_mav_mission_request", 10, from_mav_mission_request_callback);
	ros::Subscriber from_mav_mission_set_current_sub = n.subscribe("/from_mav_mission_set_current", 10, from_mav_mission_set_current_callback);
	ros::Subscriber from_mav_mission_current_sub = n.subscribe("/from_mav_mission_current", 10, from_mav_mission_current_callback);
	ros::Subscriber from_mav_mission_request_list_sub = n.subscribe("/from_mav_mission_request_list", 10, from_mav_mission_request_list_callback);
	ros::Subscriber from_mav_mission_count_sub = n.subscribe("/from_mav_mission_count", 10, from_mav_mission_count_callback);
	ros::Subscriber from_mav_mission_clear_all_sub = n.subscribe("/from_mav_mission_clear_all", 10, from_mav_mission_clear_all_callback);
	ros::Subscriber from_mav_mission_item_reached_sub = n.subscribe("/from_mav_mission_item_reached", 10, from_mav_mission_item_reached_callback);
	ros::Subscriber from_mav_mission_ack_sub = n.subscribe("/from_mav_mission_ack", 10, from_mav_mission_ack_callback);
	ros::Subscriber from_mav_set_gps_global_origin_sub = n.subscribe("/from_mav_set_gps_global_origin", 10, from_mav_set_gps_global_origin_callback);
	ros::Subscriber from_mav_gps_global_origin_sub = n.subscribe("/from_mav_gps_global_origin", 10, from_mav_gps_global_origin_callback);
	ros::Subscriber from_mav_set_local_position_setpoint_sub = n.subscribe("/from_mav_set_local_position_setpoint", 10, from_mav_set_local_position_setpoint_callback);
	ros::Subscriber from_mav_local_position_setpoint_sub = n.subscribe("/from_mav_local_position_setpoint", 10, from_mav_local_position_setpoint_callback);
	ros::Subscriber from_mav_global_position_setpoint_int_sub = n.subscribe("/from_mav_global_position_setpoint_int", 10, from_mav_global_position_setpoint_int_callback);
	ros::Subscriber from_mav_set_global_position_setpoint_int_sub = n.subscribe("/from_mav_set_global_position_setpoint_int", 10, from_mav_set_global_position_setpoint_int_callback);
	ros::Subscriber from_mav_safety_set_allowed_area_sub = n.subscribe("/from_mav_safety_set_allowed_area", 10, from_mav_safety_set_allowed_area_callback);
	ros::Subscriber from_mav_safety_allowed_area_sub = n.subscribe("/from_mav_safety_allowed_area", 10, from_mav_safety_allowed_area_callback);
	ros::Subscriber from_mav_set_roll_pitch_yaw_thrust_sub = n.subscribe("/from_mav_set_roll_pitch_yaw_thrust", 10, from_mav_set_roll_pitch_yaw_thrust_callback);
	ros::Subscriber from_mav_set_roll_pitch_yaw_speed_thrust_sub = n.subscribe("/from_mav_set_roll_pitch_yaw_speed_thrust", 10, from_mav_set_roll_pitch_yaw_speed_thrust_callback);
	ros::Subscriber from_mav_roll_pitch_yaw_thrust_setpoint_sub = n.subscribe("/from_mav_roll_pitch_yaw_thrust_setpoint", 10, from_mav_roll_pitch_yaw_thrust_setpoint_callback);
	ros::Subscriber from_mav_roll_pitch_yaw_speed_thrust_setpoint_sub = n.subscribe("/from_mav_roll_pitch_yaw_speed_thrust_setpoint", 10, from_mav_roll_pitch_yaw_speed_thrust_setpoint_callback);
	ros::Subscriber from_mav_set_quad_motors_setpoint_sub = n.subscribe("/from_mav_set_quad_motors_setpoint", 10, from_mav_set_quad_motors_setpoint_callback);
	ros::Subscriber from_mav_set_quad_swarm_roll_pitch_yaw_thrust_sub = n.subscribe("/from_mav_set_quad_swarm_roll_pitch_yaw_thrust", 10, from_mav_set_quad_swarm_roll_pitch_yaw_thrust_callback);
	ros::Subscriber from_mav_nav_controller_output_sub = n.subscribe("/from_mav_nav_controller_output", 10, from_mav_nav_controller_output_callback);
	ros::Subscriber from_mav_set_quad_swarm_led_roll_pitch_yaw_thrust_sub = n.subscribe("/from_mav_set_quad_swarm_led_roll_pitch_yaw_thrust", 10, from_mav_set_quad_swarm_led_roll_pitch_yaw_thrust_callback);
	ros::Subscriber from_mav_state_correction_sub = n.subscribe("/from_mav_state_correction", 10, from_mav_state_correction_callback);
	ros::Subscriber from_mav_request_data_stream_sub = n.subscribe("/from_mav_request_data_stream", 10, from_mav_request_data_stream_callback);
	ros::Subscriber from_mav_data_stream_sub = n.subscribe("/from_mav_data_stream", 10, from_mav_data_stream_callback);
	ros::Subscriber from_mav_manual_control_sub = n.subscribe("/from_mav_manual_control", 10, from_mav_manual_control_callback);
	ros::Subscriber from_mav_rc_channels_override_sub = n.subscribe("/from_mav_rc_channels_override", 10, from_mav_rc_channels_override_callback);
	ros::Subscriber from_mav_vfr_hud_sub = n.subscribe("/from_mav_vfr_hud", 10, from_mav_vfr_hud_callback);
	ros::Subscriber from_mav_command_long_sub = n.subscribe("/from_mav_command_long", 10, from_mav_command_long_callback);
	ros::Subscriber from_mav_command_ack_sub = n.subscribe("/from_mav_command_ack", 10, from_mav_command_ack_callback);
	ros::Subscriber from_mav_roll_pitch_yaw_rates_thrust_setpoint_sub = n.subscribe("/from_mav_roll_pitch_yaw_rates_thrust_setpoint", 10, from_mav_roll_pitch_yaw_rates_thrust_setpoint_callback);
	ros::Subscriber from_mav_manual_setpoint_sub = n.subscribe("/from_mav_manual_setpoint", 10, from_mav_manual_setpoint_callback);
	ros::Subscriber from_mav_local_position_ned_system_global_offset_sub = n.subscribe("/from_mav_local_position_ned_system_global_offset", 10, from_mav_local_position_ned_system_global_offset_callback);
	ros::Subscriber from_mav_hil_state_sub = n.subscribe("/from_mav_hil_state", 10, from_mav_hil_state_callback);
	ros::Subscriber from_mav_hil_controls_sub = n.subscribe("/from_mav_hil_controls", 10, from_mav_hil_controls_callback);
	ros::Subscriber from_mav_hil_rc_inputs_raw_sub = n.subscribe("/from_mav_hil_rc_inputs_raw", 10, from_mav_hil_rc_inputs_raw_callback);
	ros::Subscriber from_mav_optical_flow_sub = n.subscribe("/from_mav_optical_flow", 10, from_mav_optical_flow_callback);
	ros::Subscriber from_mav_global_vision_position_estimate_sub = n.subscribe("/from_mav_global_vision_position_estimate", 10, from_mav_global_vision_position_estimate_callback);
	ros::Subscriber from_mav_vision_position_estimate_sub = n.subscribe("/from_mav_vision_position_estimate", 10, from_mav_vision_position_estimate_callback);
	ros::Subscriber from_mav_vision_speed_estimate_sub = n.subscribe("/from_mav_vision_speed_estimate", 10, from_mav_vision_speed_estimate_callback);
	ros::Subscriber from_mav_vicon_position_estimate_sub = n.subscribe("/from_mav_vicon_position_estimate", 10, from_mav_vicon_position_estimate_callback);
	ros::Subscriber from_mav_highres_imu_sub = n.subscribe("/from_mav_highres_imu", 10, from_mav_highres_imu_callback);
	ros::Subscriber from_mav_file_transfer_start_sub = n.subscribe("/from_mav_file_transfer_start", 10, from_mav_file_transfer_start_callback);
	ros::Subscriber from_mav_file_transfer_dir_list_sub = n.subscribe("/from_mav_file_transfer_dir_list", 10, from_mav_file_transfer_dir_list_callback);
	ros::Subscriber from_mav_file_transfer_res_sub = n.subscribe("/from_mav_file_transfer_res", 10, from_mav_file_transfer_res_callback);
	ros::Subscriber from_mav_battery_status_sub = n.subscribe("/from_mav_battery_status", 10, from_mav_battery_status_callback);
	ros::Subscriber from_mav_setpoint_8dof_sub = n.subscribe("/from_mav_setpoint_8dof", 10, from_mav_setpoint_8dof_callback);
	ros::Subscriber from_mav_setpoint_6dof_sub = n.subscribe("/from_mav_setpoint_6dof", 10, from_mav_setpoint_6dof_callback);
	ros::Subscriber from_mav_memory_vect_sub = n.subscribe("/from_mav_memory_vect", 10, from_mav_memory_vect_callback);
	ros::Subscriber from_mav_debug_vect_sub = n.subscribe("/from_mav_debug_vect", 10, from_mav_debug_vect_callback);
	ros::Subscriber from_mav_named_value_float_sub = n.subscribe("/from_mav_named_value_float", 10, from_mav_named_value_float_callback);
	ros::Subscriber from_mav_named_value_int_sub = n.subscribe("/from_mav_named_value_int", 10, from_mav_named_value_int_callback);
	ros::Subscriber from_mav_statustext_sub = n.subscribe("/from_mav_statustext", 10, from_mav_statustext_callback);
	ros::Subscriber from_mav_debug_sub = n.subscribe("/from_mav_debug", 10, from_mav_debug_callback);
	ros::Subscriber from_mav_sensor_offsets_sub = n.subscribe("/from_mav_sensor_offsets", 10, from_mav_sensor_offsets_callback);
	ros::Subscriber from_mav_set_mag_offsets_sub = n.subscribe("/from_mav_set_mag_offsets", 10, from_mav_set_mag_offsets_callback);
	ros::Subscriber from_mav_meminfo_sub = n.subscribe("/from_mav_meminfo", 10, from_mav_meminfo_callback);
	ros::Subscriber from_mav_ap_adc_sub = n.subscribe("/from_mav_ap_adc", 10, from_mav_ap_adc_callback);
	ros::Subscriber from_mav_digicam_configure_sub = n.subscribe("/from_mav_digicam_configure", 10, from_mav_digicam_configure_callback);
	ros::Subscriber from_mav_digicam_control_sub = n.subscribe("/from_mav_digicam_control", 10, from_mav_digicam_control_callback);
	ros::Subscriber from_mav_mount_configure_sub = n.subscribe("/from_mav_mount_configure", 10, from_mav_mount_configure_callback);
	ros::Subscriber from_mav_mount_control_sub = n.subscribe("/from_mav_mount_control", 10, from_mav_mount_control_callback);
	ros::Subscriber from_mav_mount_status_sub = n.subscribe("/from_mav_mount_status", 10, from_mav_mount_status_callback);
	ros::Subscriber from_mav_fence_point_sub = n.subscribe("/from_mav_fence_point", 10, from_mav_fence_point_callback);
	ros::Subscriber from_mav_fence_fetch_point_sub = n.subscribe("/from_mav_fence_fetch_point", 10, from_mav_fence_fetch_point_callback);
	ros::Subscriber from_mav_fence_status_sub = n.subscribe("/from_mav_fence_status", 10, from_mav_fence_status_callback);
	ros::Subscriber from_mav_ahrs_sub = n.subscribe("/from_mav_ahrs", 10, from_mav_ahrs_callback);
	ros::Subscriber from_mav_simstate_sub = n.subscribe("/from_mav_simstate", 10, from_mav_simstate_callback);
	ros::Subscriber from_mav_hwstatus_sub = n.subscribe("/from_mav_hwstatus", 10, from_mav_hwstatus_callback);
	ros::Subscriber from_mav_radio_sub = n.subscribe("/from_mav_radio", 10, from_mav_radio_callback);
	ros::Subscriber from_mav_limits_status_sub = n.subscribe("/from_mav_limits_status", 10, from_mav_limits_status_callback);
	ros::Subscriber from_mav_wind_sub = n.subscribe("/from_mav_wind", 10, from_mav_wind_callback);
	ros::Subscriber from_mav_data16_sub = n.subscribe("/from_mav_data16", 10, from_mav_data16_callback);
	ros::Subscriber from_mav_data32_sub = n.subscribe("/from_mav_data32", 10, from_mav_data32_callback);
	ros::Subscriber from_mav_data64_sub = n.subscribe("/from_mav_data64", 10, from_mav_data64_callback);
	ros::Subscriber from_mav_data96_sub = n.subscribe("/from_mav_data96", 10, from_mav_data96_callback);
